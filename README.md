...
- **Sub-agent tools**: Limited to `complete_task`, `today` (no `reply` — sub-agents deliver work via `complete_task`, not chat). Environment info (OS/shell/cwd) lives in the system prompt.
