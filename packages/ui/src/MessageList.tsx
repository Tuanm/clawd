...
function ToolCallCombinedView({ start, result }: { start: StreamEntry; result: StreamEntry | null }) {
  ...
  // Default collapsed when completed/errored (matches old tool_end/tool_error behavior)
  ...
  const statusClass = isPending ? "stream-tool-start" : isError ? "stream-tool-error" : "stream-tool-end";
