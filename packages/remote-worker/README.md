...
CLAWD_WORKER_TOKEN=your-token npx tsx packages/remote-worker/typescript/remote-worker.ts \
  --server wss://your-clawd-server.example.com
```
...
ExecStart=/usr/bin/python3 /opt/remote-worker/remote_worker.py --server wss://clawd.example.com --project-root /home/deploy/project
Restart=always
RestartSec=5
...
<dict>
  ...
  <array>
    ...
    <string>/opt/remote-worker/remote_worker.py</string>
