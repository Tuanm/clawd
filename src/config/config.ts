...
export function loadConfig(): AppConfig {
  ...
  try {
    ...
    if (error instanceof Error && (error as any).code === "ERR_PARSE_ARGS_UNKNOWN_OPTION") {
 ...
 * @deprecated Currently a no-op. TODO: implement port range (1-65535), host format,
 * and heartbeat interval sanity checks before this function is relied upon.
 */
